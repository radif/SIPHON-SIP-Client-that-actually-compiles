...
export CC_NAME := gcc
export TARGET_NAME := i686-apple-darwin9
export CROSS_COMPILE := i686-apple-darwin9-
...
export PJDIR := /Users/radif/yourvirtualsim/src/Siphon/pjproject-2.0-simulator
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-O2 -m32 -miphoneos-version-min=4.0 -DPJ_SDK_NAME="\"iPhoneSimulator5.1.sdk\"" -arch i686 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-O2 -arch i686 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -framework AudioToolbox -framework Foundation
export APP_LDLIBS := -lpjsua-$(TARGET_NAME)\
	...
	$(APP_THIRD_PARTY_EXT)\
	-lpj-$(TARGET_NAME)\
	-lpthread  -framework CoreAudio -framework AudioToolbox  -framework CFNetwork
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-O2 -m32 -miphoneos-version-min=4.0 -DPJ_SDK_NAME="\"iPhoneSimulator5.1.sdk\"" -arch i686 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator5.1.sdk -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
